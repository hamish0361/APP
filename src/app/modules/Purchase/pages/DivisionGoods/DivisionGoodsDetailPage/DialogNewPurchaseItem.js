...
DialogNewPurchaseItem.propTypes = {
    show: PropTypes.bool,
...
function DialogNewPurchaseItem({
    show,
    onHide,
    onSearchProductAll,
    onSearchProduct,
    ...
    const { taxList, trackings, orderItems } = useSelector(
        ({ home, purchase, order }) => ({
...
export default injectIntl(connect(null, null)(DialogNewPurchaseItem));
